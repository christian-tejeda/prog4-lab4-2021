...
public:
    ...
    virtual set<DataVideojuego> obtenerVideojuegosDeJugadorConSuscripcionActiva(Fecha fecha) = 0;

    virtual set<DataPartidaIndividual> obtenerPartidasFinalizadasDeJugador() = 0;

    virtual void esTransmitidaEnVivo(bool enVivo) = 0;
    ...
    virtual void confirmarIniciarPartida(Fecha inicio) = 0;
